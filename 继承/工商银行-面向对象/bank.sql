...
insert  into `user`(`account`,`username`,`password`,`country`,`province`,`street`,`door`,`money`,`registerDate`,`bankname`) values ('e0jPCP6r','jason',123456,'cn','cn','cn','cn','3000.00','2021-10-06 17:58:45','中国工商银行昌平支行');
